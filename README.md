...
## 🧩 Tech Stack
<p align="start">
  <img src="https://skillicons.dev/icons?i=js,ts,go,python,markdown,,react,redux,nextjs,gatsby,svelte,,nodejs,expressjs,mongo,mysql,postgres,,css,tailwind,scss,figma,xd,,docker,vscode,linux,ubuntu,arch,windows&theme=dark">
</p>
