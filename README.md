...
## 🧩 Tech Stack
<p align="start">
  <img src="https://skillicons.dev/icons?i=js,ts,go,python,markdown,react,redux,nextjs,gatsby,svelte,nodejs,expressjs,mongo,mysql,graphql,postgres,prisma,css,tailwind,scss,figma,neovim,docker,aws,vscode,postman,linux,ubuntu,arch,windows&theme=dark">
</p>
